...
/*
1009 - Faça um programa que leia o nome de um vendedor, o seu salário fixo e o total de vendas efetuadas
...
public class SalarioComBonus {
    public static void main(String[] args) {
        ...
        String nomeVendedor = leitura.nextLine();
        double salarioFixo = leitura.nextDouble();
        double totalVendas = leitura.nextDouble();
